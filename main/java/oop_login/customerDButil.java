...
public class customerDButil {
	...
	public static List<Customer> insertCustomer(String name, String address, String phone, String email, String un, String pw) {
	    ...
	    // Simple validation to check if any of the input fields are empty
	    if (name.isEmpty() || address.isEmpty() || phone.isEmpty() || email.isEmpty() || un.isEmpty() || pw.isEmpty()) {
	        System.out.println("All fields are required");
	        return cus; // Return empty list since validation failed
	    }
	    ...
	    try {
	        ...
	        // Close resources (connection, statement, result set) to avoid memory leaks
	        try {
	            if(rs != null) rs.close();
